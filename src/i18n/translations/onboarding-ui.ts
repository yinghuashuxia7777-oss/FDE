export const onboardingUiZhCN: Record<string, string> = {
  'onboarding.mode.label': 'AI GROWTH OS · 首次设置',
  'onboarding.welcome.title': '生成你的 AI Engineer 成长档案',
  'onboarding.welcome.description':
    '选择成长目标和当前经验，我们会用现有内容生成第一项真实工程任务。',
  'onboarding.welcome.value':
    '这不是课程目录。每一步都会把学习转化为可以解释的能力证据。',
  'onboarding.loop.label': '能力成长闭环',
  'onboarding.loop.learn': '学习',
  'onboarding.loop.practice': '练习',
  'onboarding.loop.challenge': '挑战',
  'onboarding.loop.evidence': '证据',
  'onboarding.loop.capability': '能力',
  'onboarding.goal.legend': '选择你的成长目标',
  ...
  'onboarding.goal.prepare-fde-career.description':
    '训练需求发现、方案设计与客户交付。',
  'onboarding.start.legend': '你的当前经验是？',
  ...
  'onboarding.profile.generate': '生成我的成长档案',
  'onboarding.profile.label': '你的成长档案',
  'onboarding.profile.title': '你的 AI Engineer 成长档案',
  'onboarding.profile.description':
    '你的目标和经验已转化为一个可执行的第一任务。',
  'onboarding.profile.goal': '成长目标',
  'onboarding.profile.experience': '当前经验',
  'onboarding.profile.stage': '当前 Journey Stage',
  'onboarding.profile.stageValue': 'Stage 0 · Engineering Foundation',
  'onboarding.profile.proof': '第一项能力证明',
  'onboarding.profile.proofValue': '完成关联 Case 后生成',
  'onboarding.profile.change': '修改目标和经验',
...
export const onboardingUiEnUS: Record<string, string> = {
  'onboarding.mode.label': 'AI GROWTH OS · FIRST SETUP',
  'onboarding.welcome.title': 'Build your AI Engineer growth profile',
  'onboarding.welcome.description':
    'Choose a growth goal and your current experience. We will generate a first mission from the existing engineering content.',
  'onboarding.welcome.value':
    'This is not a course catalog. Every step turns learning into explainable capability evidence.',
  'onboarding.loop.label': 'Capability growth loop',
  'onboarding.loop.learn': 'Learn',
  'onboarding.loop.practice': 'Practice',
  'onboarding.loop.challenge': 'Challenge',
  'onboarding.loop.evidence': 'Evidence',
  'onboarding.loop.capability': 'Capability',
  'onboarding.goal.legend': 'Choose your growth goal',
  ...
  'onboarding.start.legend': 'What is your experience level?',
  ...
  'onboarding.profile.generate': 'Generate my growth profile',
  'onboarding.profile.label': 'Your growth profile',
  'onboarding.profile.title': 'Your AI Engineer growth profile',
  'onboarding.profile.description':
    'Your goal and experience now produce one clear first mission.',
  'onboarding.profile.goal': 'Growth goal',
  'onboarding.profile.experience': 'Current experience',
  'onboarding.profile.stage': 'Current Journey Stage',
  'onboarding.profile.stageValue': 'Stage 0 · Engineering Foundation',
  'onboarding.profile.proof': 'First capability proof',
  'onboarding.profile.proofValue': 'Earned after the related Case',
  'onboarding.profile.change': 'Change goal and experience',

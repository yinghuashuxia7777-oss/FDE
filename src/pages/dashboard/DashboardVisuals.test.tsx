...
it('presents the daily mission as Learn, Practice, Challenge, and Evidence', () => {
  render(
    <MemoryRouter>
      <GrowthMissionCard
        actionLabel="Continue today's growth mission"
        actionTo="/foundation/retry"
        complete={false}
  ...
  expect(
    screen.getByRole('link', { name: "Continue today's growth mission" }),
  ).toHaveAttribute('href', '/foundation/retry');
